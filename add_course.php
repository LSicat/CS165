...
if($bool){
	...
	$insert = mysql_query("INSERT INTO `program`(`program_id`, `name`, `num_faculty_ba_bs`, `num_faculty_ma_ms`, `num_faculty_phd`, `num_students_ba_bs`, `num_students_ms_ma`, `num_students_phd`, `cost_per_student`) 
	  									VALUES ('$school','$name','$num_faculty_ba_bs','$num_faculty_ma_ms', '$num_faculty_phd', '$num_students_ba_bs', '$num_students_ms_ma', '$num_students_phd', '$cost_per_student');");
	$insert = mysql_query("INSERT INTO offers (`offers_id`,`school_id`,`program_id`)
										VALUES ('$school','$school_id','$school');");
